            ...
            {isLoading ? (
                ...
                <>
                    <StyledTopContainer>
                        ...
                        <StyledTopOptions>
                            <StyledForm onSubmit={handleSubmitImage} onClick={(e) => e.stopPropagation()}>
                                <StyledInnerForm>
                                    <StyledFileDiv>
                                        <StyledImgLabel htmlFor="imageInput">Choose image for icon(max 5MB)</StyledImgLabel>
                            ...
                            <StyledIconsDiv onClick={handleClickIconOption}>
                                <StyledIconButton onClick={() => setIconOptions(!iconOptions)}>Icons</StyledIconButton>
                                {(iconOptions && iconData) && <StyledIconsDisplay>
                    ...
                    <StyledChangePw onClick={handleChangePassword}>Change Password</StyledChangePw >
                    <StyledTextDivs>
                        <div>About Me:</div>
                        <StyledChangeFields fieldname="aboutMe" myData={data.user} updater={updateMe} area={true} />
                    </StyledTextDivs>

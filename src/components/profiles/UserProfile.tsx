...
export default function UserProfile() {
  ...
  const handleFriendRequest = function sendFriendRequestToUser(
    ...
    makeRequest({ targetid: data.user.id, type: "FRIEND" })
      .unwrap()
      .then(() => {
        ...
        <>
          ...
          <StyledActionsContainer>
            <StyledButtonsContainer>
              <StyledAddFriend ref={buttonRef} onClick={handleFriendRequest}>
                Add Friend
              </StyledAddFriend>
              <StyledStartConvo userid={data.user.id} />
            </StyledButtonsContainer>
            <StyledGroupButtonContainer style={{ position: "relative" }}>
              <StyledInvite onClick={() => setShowOptions(!showOptions)}>
                invite to group
              </StyledInvite>
              {showOptions && (
                <GroupSelection

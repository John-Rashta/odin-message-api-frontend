...
export default function Friends() {
    ...
    return (
        <StyledMain>
            {isLoading ? <StyledExtraMessage>Loading Friends...</StyledExtraMessage>
            : error ? <StyledExtraMessage>Failed Getting Friends!</StyledExtraMessage>
            ...
            })) || <StyledExtraMessage>No Friends Yet!</StyledExtraMessage>  : <StyledExtraMessage>No Friends Yet!</StyledExtraMessage>
            }
        </StyledMain>
    )
};
